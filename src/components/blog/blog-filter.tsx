      ...
      <div className="grid gap-6 lg:grid-cols-2 xl:grid-cols-3">
        {filteredPosts.map((post, index) => (
          <article
            key={post.slug}
            className={cn(
              "group section-surface noise-overlay relative overflow-hidden rounded-[1.85rem] p-6 transition duration-500 hover:-translate-y-1",
