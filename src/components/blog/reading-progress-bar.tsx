...
export function ReadingProgressBar() {
  ...
  return (
    ...
    >
      <div
        className="h-full bg-gradient-to-r from-violet-500 via-fuchsia-500 to-cyan-400 shadow-[0_0_12px_rgba(139,92,246,0.5)] transition-all duration-150 ease-out"
