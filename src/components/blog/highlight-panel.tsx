...
export function HighlightPanel({ children, className = "" }: HighlightPanelProps) {
  return (
    <div
      className={`relative my-10 overflow-hidden rounded-[1.5rem] border border-violet-400/20 bg-gradient-to-br from-white/[0.06] to-white/[0.02] px-6 py-6 shadow-[0_0_30px_rgba(139,92,246,0.06)] backdrop-blur-md sm:px-8 sm:py-7 ${className}`}
    >
