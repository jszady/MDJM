export const caseStudies = [
  {
    slug: "geek-my-interest-media-platform",
    title: "Geek My Interest",
    category: "Web platform + Brand site",
    url: "https://www.geekmyinterest.com",
    logo: "/geek-my-interest-logo.webp",
    logoAlt: "Geek My Interest logo — geek culture media platform and brand site built by MJDM",
    summary:
  ...
  },
  {
    ...
    title: "Icon Body and Mind",
    category: "Website + Personal brand",
    url: "https://www.iconbodyandmind.ca",
    logo: "/icon-body-and-mind-logo.png",
    logoAlt: "Icon Body and Mind logo — Toronto-area personal training and coaching website by MJDM",
    summary:
  ...
  },
  {
    ...
    title: "CA Building Supply",
    category: "B2B website + Product showcase",
    url: "https://www.cabuildingsupply.ca",
    logo: "/ca-building-supply-logo.webp",
    logoAlt: "CA Building Supply logo — Ontario exterior materials supplier B2B website built by MJDM",
    summary:
